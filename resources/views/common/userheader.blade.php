 <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Scheduling</b>App</span>
    </a>
            ...
            <li><a href="{{URL::route('setuproles')}}"><i class="fa fa-circle-o"></i> Set up Roles </a></li>
             ...
             <li><a href="{{URL::route('setuptasks')}}"><i class="fa fa-circle-o"></i> Set up Tasks</a></li>
				  ...
				  <li><a href="{{URL::route('setupteammember')}}"><i class="fa fa-circle-o"></i> Set up Team</a></li> 
				   <li><a href="{{URL::route('setupjobs')}}"><i class="fa fa-circle-o"></i> Set up Job Type Template</a></li>
                   ...
                   <li><a href="{{URL::route('viewtaskstates')}}"><i class="fa fa-circle-o"></i> Job Phase</a></li>				  
                   <li><a href="{{URL::route('viewcustomerdevelopments')}}"><i class="fa fa-circle-o"></i> Developments / Subdivisions</a></li>
                   <li><a href="{{URL::route('viewcustomersitelocations')}}"><i class="fa fa-circle-o"></i> Projects</a></li>				   
